local sexyahh = true
if sexyahh == true then
	--[ INITIALISING THE UI
	local Library, Flags, Subs = loadstring(game:HttpGet("https://raw.githubusercontent.com/gmofi/BBC/main/uilib.lua"))()
	local Window = Library:CreateWindow({
		Name = "BBC HUB NEWEST CRACK AGAIN",	
	...
	local skinChangerToggle = skinChangerSec:AddToggle({
		...
		Callback = function(value)
			...
			while values.enabled["skinChanger"] do task.wait(1)
				...
				local Karambit = game.ReplicatedStorage.ViewModels:FindFirstChild("Karambit")
